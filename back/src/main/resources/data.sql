...
(1, 'Excellent article ! Spring Boot 3 semble vraiment prometteur avec GraalVM. As-tu déjà testé les performances en production ?', 2, 1, CURRENT_TIMESTAMP),
(2, 'Merci pour ce guide complet. La partie sur les composants réactifs est particulièrement utile pour mon projet actuel.', 3, 2, CURRENT_TIMESTAMP),
(3, 'Les types conditionnels de TypeScript sont un vrai game-changer. Peux-tu donner un exemple concret d''utilisation ?', 1, 3, CURRENT_TIMESTAMP),
(4, 'SOLID est effectivement fondamental. J''ajouterais que l''application de ces principes doit rester pragmatique selon le contexte.', 4, 4, CURRENT_TIMESTAMP),
(5, 'L''architecture hexagonale a transformé notre façon de structurer les projets. Plus jamais de couplage fort avec les frameworks !', 2, 5, CURRENT_TIMESTAMP),
(6, 'Virtual Threads vont révolutionner la concurrence en Java. Enfin une alternative simple aux CompletableFuture !', 1, 6, CURRENT_TIMESTAMP),
(7, 'RxJS peut être déroutant au début, mais une fois maîtrisé, c''est un outil incroyablement puissant pour gérer les flux complexes.', 4, 7, CURRENT_TIMESTAMP),
(8, 'JUnit 5 est un vrai plaisir à utiliser. Les tests paramétrés ont grandement simplifié notre suite de tests.', 5, 8, CURRENT_TIMESTAMP),
(9, '@john.doe Pour GraalVM, j''ai testé en préproduction et le gain en temps de démarrage est impressionnant, surtout pour les microservices.', 1, 1, CURRENT_TIMESTAMP),
(10, 'Pourrais-tu faire un article de suivi sur les tests d''intégration avec Spring Boot 3 ?', 3, 1, CURRENT_TIMESTAMP),
(11, 'La gestion d''état avec NgRx serait un excellent complément à cet article sur RxJS.', 5, 7, CURRENT_TIMESTAMP),
(12, 'Très bon rappel sur SOLID. Dans notre équipe, nous organisons des code reviews spécifiquement sur ces principes.', 3, 4, CURRENT_TIMESTAMP),
(13, 'L''exemple d''architecture hexagonale est clair. As-tu des recommandations de ressources pour approfondir ?', 2, 5, CURRENT_TIMESTAMP),
(14, 'Java 21 LTS arrive à point nommé. Les Virtual Threads vont simplifier tant de choses dans nos applications serveur.', 4, 6, CURRENT_TIMESTAMP),
(15, 'Excellent point sur le debouncing ! C''est souvent oublié mais tellement important pour les performances UX.', 1, 7, CURRENT_TIMESTAMP);
